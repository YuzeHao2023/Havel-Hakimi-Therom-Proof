...
function restart() {
  ...
  g.append("svg:circle")
    ...
    .on("mouseup", function (d) {
      ...
      // Add link to graph. Ensure that source is always less than target.
      var source, target;
...
function keydown() {
  ...
  switch (lastKeyDown) {
    ...
    case 46: // delete
      ...
      link.source.currentDegree--; 
      link.target.currentDegree--;
